          ...
          <v-card>
            <v-container>
              <v-form @submit.prevent="addEvent">
                ...
                <v-text-field type="text" label="Agregar el detalle" v-model="details">
                </v-text-field>
                ...
                <v-btn type="submit" class="mr-4" color="primary" @click.stop="dialog = false">Agregar</v-btn>
              </v-form>
            </v-container>
          </v-card>
        </v-dialog>
        ...
        >
          ...
          >
            ...
            <v-card-text>
              ...
              <v-form v-else>
                <v-text-field label="Editar nombre" v-model="selectedEvent.name"></v-text-field>
